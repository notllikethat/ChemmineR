...
```{r eval=FALSE}
 ...
 BiocManager::install("ChemmineR") # Installs the package. 
...
```{r eval=TRUE, tidy=FALSE,fig.height=5,fig.width=5}
...
```{r eval=TRUE, tidy=FALSE, dev='svg',fig.height=5,fig.width=5}
...
```{r datatable, eval=TRUE, tidy=FALSE}
data(sdfsample)
